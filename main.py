...
def proc2():
    ...
    my_stand = IceCreamStand("Желтый снег", ['ванильное', 'шоколадное', 'клубничное', 'малиновое'], 'Невский проспект', '12.00 - 18.00', ['эскимо', 'стакан', 'фруктоввый лед', 'алкогольное'])
...
def proc3():
    ...
    class IceCreamStand:
        ...
        def get_menu(self):
            menu = "Добро пожаловать в ларек мороженного " + self.name + "\n"
    ...
    my_stand = IceCreamStand("Желтая сосулька", ["ванильный", "шоколад", "ягодный"])

    root = tk.Tk()
    root.title("Желтая сосулька")
